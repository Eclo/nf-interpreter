...
list(APPEND STM32H7_CubePackage_INCLUDE_DIRS ${CMAKE_SOURCE_DIR}/targets/AzureRTOS/ST/_common/drivers/flash)
list(APPEND STM32H7_CubePackage_INCLUDE_DIRS ${CMAKE_SOURCE_DIR}/src/CLR/Include)
list(APPEND STM32H7_CubePackage_INCLUDE_DIRS ${azure_rtos_SOURCE_DIR}/common/inc)
...
foreach(SRC_FILE ${STM32H7_CubePackage_SRCS})
    ...
    find_file(STM32H7_CubePackage_SRC_FILE ${SRC_FILE}
        ...
        ${CMAKE_SOURCE_DIR}/targets/AzureRTOS/ST/_common/drivers/flash/v5
...
list(REMOVE_DUPLICATES STM32H7_CubePackage_SOURCES)
