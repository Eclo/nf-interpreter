...
HRESULT CLR_RT_HeapBlock_Queue::ObjArrayMemcpy(
...
HRESULT CLR_RT_HeapBlock_Queue::CopyTo(CLR_RT_HeapBlock_Array *toArray, CLR_INT32 index)
{
    ...
    if (((CLR_INT32)toArray->m_numOfElements) - index < size)
...
CT_ASSERT(
    Library_nf_system_collections_System_Collections_Queue__FIELD___array ==
    Library_nf_system_collections_System_Collections_Queue::FIELD___array);
CT_ASSERT(
    Library_nf_system_collections_System_Collections_Queue__FIELD___head ==
    Library_nf_system_collections_System_Collections_Queue::FIELD___head);
CT_ASSERT(
    Library_nf_system_collections_System_Collections_Queue__FIELD___tail ==
    Library_nf_system_collections_System_Collections_Queue::FIELD___tail);
CT_ASSERT(
    Library_nf_system_collections_System_Collections_Queue__FIELD___size ==
    Library_nf_system_collections_System_Collections_Queue::FIELD___size);
